      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
			<!--- tambah data -->
			<form class="form-horizontal" action="add_buku.php" method="post">
			<div class="form-group col-md-6">
				  <label for="">KD_BUKU</label>
				  <input type="text" class="form-control" name="kd_buku" placeholder="KD_BUKU">
				</div>
				<div class="form-group col-md-6">
				  <label for="">NM_BUKU</label>
				  <input type="text" class="form-control" name="nm_buku" placeholder="NM_BUKU">
			  </div>
			  <div class="form-row">
			  <div class="form-group col-md-6">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
		include 'koneksi.php';
		$stid = oci_parse($koneksi, 'SELECT * from buku_123');
		...
		while (($d = oci_fetch_array ($stid, OCI_BOTH)) != false) {
			?>
                        <tr>                          
                          ...
                          <td class="td-actions">
						  <a href="buku_update.php?id=<?= $d['KD_BUKU'] ?>">
                            <button type="button" rel="tooltip" class="btn btn-success">
                              <i class="material-icons">edit</i>
                            </button></a>
							<a href="delete_buku.php?id=<?= $d['KD_BUKU'] ?>" 
